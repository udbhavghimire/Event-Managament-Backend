...
# Absolute base URL for media when building links without a request (e.g. scripts).
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "EventEase <noreply@udbhavghimire.com.np>")
